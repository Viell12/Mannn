...
<i class="fas fa-sign-out-alt mr-2"></i>Logout
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Aplikasi Penggajian</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('dist/img/photo3.jpg')}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('pegawai.index')}}" class="nav-link {{ ($title==='Pegawai')?'active':''}}">
                        ...
                        <li class="nav-item">
                            <a href="gajian" target="_blank" class="nav-link {{ ($title==='Gajian') ? 'active':'' }}">
